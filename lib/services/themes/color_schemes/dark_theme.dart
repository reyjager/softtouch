...
class LamsatDarkThemeColurScheme implements LamsatAppColorScheme {
  ...
  final MaterialColor _secondaryColor = const MaterialColor(0xFF21125E, {
    100: Color(0xFF48B1BA),
    200: Color(0xFF28929B),
    300: Color(0xFF03383C),
  });
  ...
  final MaterialColor _warningColor = const MaterialColor(0xFFD7B53D, {
    100: Color(0xFFFFF5D2),
  });

  @override
  MaterialColor get warningColor => _warningColor;

  final MaterialColor _infoColor = const MaterialColor(0xFF264797, {
    100: Color(0xFFEFF4FF),
  });
  ...
  final MaterialColor _backgroundColor = const MaterialColor(0xFFFFFFFF, {
    100: Color(0x00EFEFEF),
  });
